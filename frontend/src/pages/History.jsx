...
import { CalendarDays, AlertTriangle, Clock, ListChecks, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    const fetchLogs = async () => {
      try {
        ...
        const grouped = logs.reduce((acc, log) => {
          ...
          if (!acc[dateStr]) {
            acc[dateStr] = { date: dateStr, sessions: 0, totalGoodTime: 0, totalWarnings: 0 };
          }
